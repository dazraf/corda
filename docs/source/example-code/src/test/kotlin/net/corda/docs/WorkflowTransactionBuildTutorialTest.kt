...
class WorkflowTransactionBuildTutorialTest {
    ...
    fun setup() {
        ...
        val aliceNode = mockNet.createPartyNode(notaryNode.network.myAddress, ALICE_NAME)
        val bobNode = mockNet.createPartyNode(notaryNode.network.myAddress, BOB_NAME)
